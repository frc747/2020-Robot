...
public class Autonomous{
    ...
    public enum AutoMode{
        /*AUTOMODE_NONE*/AUTOMODE_BROWNIES/*,
        AUTOMODE_TEST,
    ...
    public Autonomous(){
        ...
        autoChooser1.setDefaultOption("Brownies", AutoMode.AUTOMODE_BROWNIES);//autoChooser1.setDefaultOption("BUCKET HEAD (No autonomous)", AutoMode.AUTOMODE_NONE);
