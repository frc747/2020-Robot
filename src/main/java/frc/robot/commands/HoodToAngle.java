...
public class HoodToAngle extends CommandBase {
  ...
  public HoodToAngle(double angle) {
    subsystem = Robot.HOOD_SUBSYSTEM;
    ...
    double distance = (0.393701 * Robot.LIDAR_SUBSYSTEM.getDistance()) - 8;
  ...
  @Override
  public void execute() {
    driveTicks = calcTicks((0.393701 * Robot.LIDAR_SUBSYSTEM.getDistance()) - 8);
